...
function Dashboard() {
  ...
  return (
    <div className="p-3.5 pb-15">

      {/* ## alert 섹션 (임시, 하드코딩) */}
      <div className="flex items-center gap-2.5 px-3.5 py-1.5 rounded-lg
        ...
        <div className="flex-8 card p-3.5 min-w-0 overflow-hidden flex items-center
          ...
          <div className="flex items-center gap-4 flex-wrap w-full">
            ...
            <div className="flex items-center gap-3.5 flex-1 min-w-44">
              <div className="w-13 h-13 rounded-xl bg-transparent 
      ...
      {/* ## 중간 부분 3열 구조 grid 구성 */}
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_270px_300px] gap-3.5">
         ...
         <div className="bg-(--surface) rounded-xl 
            ...
            <div className="px-4.5 py-4 border-b border-(--border)">
              <div className="flex justify-between items-center mb-2.5">
                ...
                <div className="flex gap-4 text-[11px] text-(--text-3)">
                  <span>최고 <b className="text-(--accent) tabular-nums">4.3</b></span>
                  <span>최저 <b className="tabular-nums">3.7</b></span>
                  <span>평균 <b className="text-(--text-1) tabular-nums">4.0</b></span>
                </div>
              </div>
              <svg viewBox="0 0 560 90" className="w-full" 
                   preserveAspectRatio="none" style={{ height: 72 }}>
                <polygon points={fillPath} fill="var(--accent)" opacity="0.12" />
                ...
                {chartData.map((p, i) => (
                  <g key={i}>
                    ...
                    <text x={p.x} y={p.y - 7} textAnchor="middle" fontSize="9" fill="var(--text-3)" fontFamily="Inter,sans-serif">
                      {p.gpa.toFixed(1)}
                    </text>
                  </g>
                ))}
            ...
            <div className="px-4.5 py-2.5 border-b border-(--border)">
              ...
              <div className="flex h-2.5 rounded-full overflow-hidden">
                ...
                <div className="w-[34%] ml-px" style={{ background: 'var(--accent)', opacity: .55 }}/>
                <div className="w-[24%] ml-px" style={{ background: 'var(--accent)', opacity: .28 }}/>
            ...
            <div className="px-4.5 py-2 border-b border-(--border) bg-(--accent-bg)
              ...
              <span className="ml-auto px-1.5 py-0.5 rounded-full text-[8px] font-semibold
                              bg-[#DBEAFE] text-[#1E40AF] whitespace-nowrap shrink-0">달성 가능 ✓</span>
            </div>
            ...
            {/* 학기별 성적 - */}
            <div className="px-4.5 py-3 bg-(--surface-2) flex items-center gap-3.5
        ...
        {/* #2열 : 목표 성적 | 커뮤니티 */}
        <div className="flex flex-col gap-3.5 order-2">
            ...
            <div className="p-3 flex flex-col flex-1 min-h-0">
              ...
              <div className="grid gap-0.5 flex-1 min-h-45"
                ...
                {[
                  ...
                  <div key={i}
                       className="rounded text-[10px] leading-tight px-1.5 py-1"
                       style={{
                         gridColumn: b.col,
                         gridRow: b.row,
